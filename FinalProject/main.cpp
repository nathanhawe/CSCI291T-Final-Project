...
_sceneManager *sceneManager = new _sceneManager();
							...
							LPARAM	lParam)			// Additional Message Information
{
	switch (uMsg)									// Check For Windows Messages
	{
		...
		case WM_KEYDOWN:							// Is A Key Being Held Down?
		{
			...
			sceneManager->winMsg(hWnd,uMsg,wParam,lParam);
			return 0;								// Jump Back
		}
		...
		{
           sceneManager->resizeWindow(LOWORD(lParam),HIWORD(lParam));                                         // LoWord=Width, HiWord=Heigh
           return 0;								// Jump Back
		}
